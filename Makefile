...
all: clean
	...
	gcc $(CFLAGS) -o $(CURDIR)/x86_64/xor_cipher $(CURDIR)/x86_64/xor_file.o $(CURDIR)/x86_64/xor_algo.o -static
	strip $(CURDIR)/x86_64/xor_cipher
	...
	aarch64-linux-gnu-gcc $(CFLAGS) -o $(CURDIR)/arm64/xor_cipher $(CURDIR)/arm64/xor_file.o $(CURDIR)/arm64/xor_algo.o -static
	aarch64-linux-gnu-strip $(CURDIR)/arm64/xor_cipher
